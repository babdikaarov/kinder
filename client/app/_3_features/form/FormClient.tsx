...
import DocNameInput from './inputs/DocNameInput'
...
import ErrorAlert from './allerts/AlertError'
import SuccessAlert from './allerts/AlertSuccess'
import { Loader } from 'lucide-react'
import AlertSubmited from './allerts/AlertSubmited'

export default function FormClient({ opt, text, locale }: TSFormProps) {
                      ...
                      <div className='w-full'>
                        ...
                        <form.Field
                          ...
                          validators={{
                            ...
                            onChange: ({ value }) => {
                              if (value) {
                                const maxFileSize = 6 * 1024 * 1024 // //file size limit 6mb
                ...
                >
                  {isSubmitting ? (
                    <>
                      ...
                      <Loader className='animate-spinSlow' />
                    </>
                  ) : (
