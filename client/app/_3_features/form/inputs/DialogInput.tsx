...
export default function DialogInput({
  ...
  useEffect(() => {
    ...
    const sizeMB = 6 * 1024 * 1024 //file size limit 6mb
      ...
      >
        ...
        <div className='flex flex-col gap-6 '>
          ...
          >
            ...
            <button
              type='button'
              className='button h-[35px]  w-[180px] bg-blue-500'
            >
              {text.upload}
            </button>
          </div>
        ...
        <DialogFooter>
          <DialogClose asChild>
            <button
              type='button'
              className={cn(
                'button h-[35px] w-[180px] self-center rounded bg-blue-500 text-white',
