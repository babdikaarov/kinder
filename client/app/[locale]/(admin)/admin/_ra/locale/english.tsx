...
const englishMessages: TranslationMessages = {
  myRoot: {
    TitleEdit: 'Documents of %{name}',
    TitleList: 'kashkaldak spisok podavshih documentov',
    status: {
      pending: 'Pending',
      accepted: 'Accepted',
      declined: 'Declined',
    ...
    document: {
      delete_title: 'Deleting document "%{name}"',
      delete_content: 'Are you sure you want to delete this document?',
    },
    bulk_delete_title:
      'Delete data record |||| Delete %{smart_count} data records',
    bulk_delete_content:
      'Are you sure you want to delete this data reocrd? |||| Are you sure you want to delete these %{smart_count} data records?',
    field: {
      inn: 'Inn',
      ...
      status: 'Status',
      formSchema: 'Applicant group',
      listDocs: 'list docs',
      downloadAll: 'All documents',
