...
const RussianTranslation: TranslationMessages = {
  myRoot: {
    TitleEdit: 'Документы %{name}',
    TitleList: 'Кашкалдак - список подавших документов',
    status: {
      pending: 'В ожидании',
      accepted: 'Принято',
      declined: 'Отклонено',
    ...
    document: {
      delete_title: 'Удаление документа "%{name}"',
      delete_content: 'Вы уверены, что хотите удалить этот документ?',
    },
    bulk_delete_title:
      'Удалить запись данных |||| Удалить %{smart_count} записи данных',
    bulk_delete_content:
      'Вы уверены, что хотите удалить эту запись данных? |||| Вы уверены, что хотите удалить эти %{smart_count} записи данных?',
    field: {
      inn: 'ИНН',
      firstName: 'Имя',
      lastName: 'Фамилия',
      ...
      createdAt: 'Создано',
      status: 'Статус',
      formSchema: 'Заявитель группа',
      listDocs: 'Cписок документов',
      downloadAll: 'Все документы',
  ...
  ra: {
    ...
    navigation: {
      ...
      partial_page_range_info:
        '%{offsetBegin}-%{offsetEnd} из более %{offsetEnd}',
