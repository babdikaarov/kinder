...
export const metadata: Metadata = {
  ...
  description:
    'Дошкольное образовательное учреждение Кашкалдак им. Азима Нарматова - местонахождение Ноокатский район, государственное детское воспитательное учреждение. Сайт для ознакомления с учреждением и отправики запрошенных документов для родителей детей зачисленных в детский сад',
  generator: 'Next.js',
  ...
  twitter: {
    ...
    title: 'Кашкалдак | Детский сад им. Азима Нарматова',
    description:
      'Дошкольное образовательное учреждение Кашкалдак им. Азима Нарматова - Ноокатский район, государственное детское воспитательное учреждение. Сайт для ознакомления с учреждением и отправики запрошенных документов для родителей детей зачисленных в детский сад',
    creator: 'Кашкалдак',
    images: [`${process.env.BASE_URL}/twitter-image.png`], // Must be an absolute URL
  },
  verification: {
    other: {
      'google-site-verification': 'e5hcamHLPO300p5l_cVQRHtMMjGQitSDIt8hKWVGIO0',
    },
  },
}
